    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextInnoket   = QChar(0xA9)+QString(" 2017-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Innoket Core developers"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+24,copyrightTextInnoket);
