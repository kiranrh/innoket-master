    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Innoket Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Innoket Core"));
...
All the Innoket in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 IKT, 0.1 IKT, 1 IKT and 10 IKT -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://innoketcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://innoketcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
