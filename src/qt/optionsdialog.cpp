    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("IKT-light"), QVariant("light"));
    ui->theme->addItem(QString("IKT-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("IKT-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("IKT-traditional"), QVariant("trad"));
