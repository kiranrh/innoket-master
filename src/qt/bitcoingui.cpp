...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Innoket Core"), this);
    aboutAction->setStatusTip(tr("Show information about Innoket Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Innoket Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Innoket Core help message to get a list with possible Innoket Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Innoket Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Innoket Core"); // default title
