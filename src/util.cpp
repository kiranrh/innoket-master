...
const char * const BITCOIN_CONF_FILENAME = "innoket.conf";
const char * const BITCOIN_PID_FILENAME = "innoketd.pid";
...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL)
    {
        ...
        if (ptrCategory.get() == NULL)
        {
            ...
            // "innoket" is a composite category enabling all Innoket-related debug output
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\InnoketCore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\InnoketCore
    // Mac: ~/Library/Application Support/InnoketCore
    // Unix: ~/.innoketcore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "InnoketCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/InnoketCore";
#else
    // Unix
    return pathRet / ".innoketcore";
#endif
#endif
}
