...
{
    const char* pszTimestamp = "The Star Malaysia 17th November 2017 Innoket Genesis Reborn";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 60 * 60; // Innoket: 1 hour, 24 blocks
        consensus.nPowTargetSpacing = 2.5 * 60; // Innoket: 150 seconds
        ...
        // Innoket script addresses start with '5'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,10);
        // Innoket private keys start with '5' or 'G' (?)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,198);
        // Innoket BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Innoket BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // Innoket BIP44 coin type is '5'
