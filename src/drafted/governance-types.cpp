...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "InnoketNetwork") type = InnoketNetwork;
    if(strType == "InnoketNetworkVariable") type = InnoketNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == InnoketNetwork) s = "InnoketNetwork";
    if(type == InnoketNetworkVariable) s = "InnoketNetworkVariable";
