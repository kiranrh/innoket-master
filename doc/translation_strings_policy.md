...
This document provides guidelines for internationalization of the Innoket Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to Innoket network</numerusform>
            <numerusform>%n active connections to Innoket network</numerusform>
        </translation>
    </message>
