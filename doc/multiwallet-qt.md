...
Only requiring some minor changes is innoket.cpp.
...
Changes to innoket.cpp
----------------------
innoket.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
