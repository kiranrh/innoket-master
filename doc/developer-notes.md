...
However, in open source software such as Innoket Core, where everyone uses
...
pay attention to for reviewers of Innoket Core code.

General Innoket Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Innoket Core uses tinyformat, which is type safe. Leave them out to avoid confusion
