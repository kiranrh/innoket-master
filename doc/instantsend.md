...
This mechanism has been integrated into Bitcore-Node-Innoket which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/innoketcoin/insight-api-innoket#web-socket-api](https://github.com/innoketcoin/insight-api-innoket#web-socket-api) 
* API: [https://github.com/innoketcoin/insight-api-innoket#instantsend-transactions](https://github.com/innoketcoin/insight-api-innoket#instantsend-transactions) 
...
By default, the Innoket Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Innoket Core daemon:
